(function() {
    ...
    .controller('QuestionHomeCtrl', function($scope, $ionicActionSheet, $state, $ionicPopup, $ionicLoading, $timeout, $ionicModal, $messageLoading, QuestionService, loginModal) {
    ...
    // Controller for Detail Page
    .controller('QuestionSearchCtrl', function($scope, $http, localStorage, questionService) {});
